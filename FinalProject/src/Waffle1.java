...
;
	...
	public Waffle1() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(Waffle1.class.getResource("/resource/1.png")));
		...
		lblNewLabel_3.setIcon(new ImageIcon(Waffle1.class.getResource("/resource/33.png")));
